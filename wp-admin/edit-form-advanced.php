...
<div id="titlediv">
    <div id="titlewrap">
        <b>Enter IMDB ID: </b> <br/> 
        <input type="text" name="imdb_id" size="30" id="imdb_id"/>
        <a href="#" id="btnImdb" class="button" title="Get IMDB Data" id="">Get IMDB Data</a>
    </div>
</div><br/>
<div id="titlediv">
    <div id="titlewrap">
        <b>Poster URL: </b><br/>
        <span id="spanPoster"></span>
    </div>
</div>
<br/> <br/>
<?php endif; ?>
