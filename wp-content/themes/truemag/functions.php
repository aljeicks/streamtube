...
function cactusthemes_scripts_styles() {
	 ...
	 * videojs.
	 */
	wp_register_script( 'videojs', get_template_directory_uri() . '/js/videojs/video.js' , array('jquery'), '', false );
...
<div class="tm-social-share">
    ...
    <a class="social-icon s-tw" href="#" title="<?php _e('Share on Twitter','cactusthemes'); ?>" rel="nofollow" target="_blank" onclick="window.open('http://twitter.com/share?text=<?php echo urlencode(get_the_title(get_the_ID())); ?>&url=<?php echo urlencode(get_permalink(get_the_ID())); ?>','twitter-share-dialog','width=626,height=436');return false;"><i class="fa fa-twitter"></i></a>
    <?php } ?>
    ...
    <a class="social-icon s-tb" href="#" title="<?php _e('Share on Tumblr','cactusthemes'); ?>" rel="nofollow" target="_blank" onclick="window.open('http://www.tumblr.com/share/link?url=<?php echo urlencode(get_permalink(get_the_ID())); ?>&name=<?php echo urlencode(get_the_title(get_the_ID())); ?>','tumblr-share-dialog','width=626,height=436');return false;"><i class="fa fa-tumblr"></i></a>
    <?php } ?>
    ...
    <a class="social-icon s-bl" href="#" title="<?php _e('Share on Blogger','cactusthemes'); ?>" rel="nofollow" target="_blank" onclick="window.open('https://www.blogger.com/blog-this.g?u=<?php echo urlencode(get_permalink(get_the_ID())); ?>&n=<?php echo urlencode(get_the_title(get_the_ID())); ?>&t=<?php echo urlencode(get_the_excerpt()); ?>','blogger-share-dialog','width=626,height=436');return false;"><i id="jv-blogger" class="jv-blogger"></i></a>
    <?php } ?>
    ...
    <a class="social-icon s-em" href="mailto:?subject=<?php echo get_the_title(get_the_ID()) ?>&body=<?php echo urlencode(get_permalink(get_the_ID())) ?>" title="<?php _e('Email this','cactusthemes'); ?>"><i class="fa fa-envelope"></i></a>
    <?php } ?>
</div>
<?php }
