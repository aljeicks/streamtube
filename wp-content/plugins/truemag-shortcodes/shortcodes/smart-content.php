...
function parse_smart_content_func($atts, $content){
	...
	$show_exceprt1 			= isset($atts['show_exceprt']) ? $atts['show_exceprt'] : '';
	$show_exceprt 			= isset($atts['show_excerpt']) ? $atts['show_excerpt'] : '';	
	...
	if(class_exists('CT_ContentHelper')){
		...
		$the_query = $item_video1->tm_get_popular_posts($condition, $tags, $count, $ids,$sort_by, $categories, $args = array(),$themes_pur,$postformats);
